...
## EXAMPLE: DATA FOLDER README WITHOUT PUSHING
...
## META EXPLANATION: Use this folder but ignore everything but the README !
If you don't push your data, but instruct people to place it in this folder (as the example above), remember to *actually* use the folder for your data, so that your paths from your scripts match this. 
...
## EXAMPLE: DATA FOLDER README WITH PUSHING
